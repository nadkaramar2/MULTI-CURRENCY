...
export default function OneToMany() {
  ...
  // From Account Holdername and Available Balance GeneratedAPI
  ...
  const OneToMany = async () => {
    if (
      ...
      try {
        const response = await amsApi.post(
          `bulkTransfer/oneToMany`,
          {
            strMakerId: useid,
            strFromAccountNo: accountno,
            strFromAccountType: accounttype,
      ...
      <div className="max-w-full mx-auto h-full">
        ...
        <div className="overflow-hidden shadow sm:rounded-md mt-2 ">
          <div className="grid  md:grid-cols-1 ">
            {/* <div className=" px-4 py-1 bg-blue-400  w-full shadow-md mt-1"> */}

            <div className="sm:p-2 bg-blue-100  ">
              <h1 className="font-medium flex justify-center  text-black text-2xl ">
                From Account Information
              </h1>
              <div className="grid gap-3 mb-1 md:grid-cols-3 lg:grid-cols-5 px-8 mt-3 ">
                <div>
                  <label
            ...
            {/* To Account info adding input */}
            <div className="overflow-x-auto relative sm:p-2 shadow-md   bg-white ">
              <h1 className="font-medium flex justify-center  text-black text-2xl ">
              ...
              {inputFields.map((inputField, index) => (
                <div
                  key={index}
                  className="grid gap-3 mb-2 md:grid-cols-5 px-8 mt-3 "
                >
                  <div>
                    <label
                      htmlFor="GL Account Type"
