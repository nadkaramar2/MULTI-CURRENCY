...
export default function Cashback_Statement() {
            ...
            <div>
              <table className="w-full text-xs text-left text-black dark:text-blue-100">
                <thead className="text-xs border-b sticky top-0 text-gray-400 uppercase bg-gray-100 dark:text-white">
                  ...
                  >
                    cash back Amount {renderSortArrow("cashbackAmount")}
                  </th>
                  <th
                    scope="col"
                    className="py-2.5 px-6 whitespace-nowrap"
                ...
                <tbody>
                  {sortedData.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan="6" className="px-3.5 py-1.5 text-center">
