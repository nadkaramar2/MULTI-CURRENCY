...
export default function ViewInterestTxn() {
  ...
  const [itemPage, setItemPage] = useState("15");
    ...
    if (duration === "" || accountno === "") {
      ...
      try {
        const response = await amsApi.post(
          `billingCycle/viewIntrstTxn/pagination/${itemPage}/${tcount}`,
          {
        ...
        if (response.data.code === "S0000") {
          setallData(response.data.revolvingCreditInterestTxns);
          setCheckpoint(1);
          setChecked(false);
        } else {
    ...
    <AppLayout>
      <div className="max-w-full mx-auto h-full">
            ...
            <form className="">
              <div className="overflow-hidden shadow sm:rounded-md ">
                <div className=" px-4  bg-white ">
                  <div className="grid gap-2 lg:grid-cols-5 px-7">
                    <div>
                      <label
                        htmlFor="number"
                    ...
                    <div className="">
                      <button
                        ...
                        className="inline-flex justify-center  bg-blue-500 hover:bg-blue-700 b  focus:ring-2 focus:ring-blue-800 focus:ring-offset-2 border-blue-700 py-1.5 px-7 mx-2 my-3    text-xs font-bold text-white rounded "
                      >
                      ...
                      <button
                        ...
                        type="button"
                        onClick={handleClick}
                        className="inline-flex justify-center  bg-rose-500 hover:bg-rose-700 b  focus:ring-2 focus:ring-rose-800 focus:ring-offset-2 border-rose-700 py-1.5 px-7 mx-2 my-3  text-xs font-bold text-white rounded "
                      >
        ...
        <div className="overflow-x-auto relative shadow-md mt-1 ">
          <div className="table-wrap block  max-h-[31rem] max-w-[29rem]">
            <table className="w-full  text-xs text-left text-clack dark:text-blue-100  ">
              <thead className="text-xm border-b sticky top-0 text-gray-400  bg-gray-100 dark:text-white">
                ...
                >
                  Tran Time {renderSortArrow("strTxnTime")}
                </th>
                <th
                  scope="col"
                  className="py-2.5 px-7 whitespace-nowrap"
                ...
                <th
                  scope="col"
                  className="py-2.5 px-7 whitespace-nowrap"
                  onClick={() => handleSort("strCalculateInterestAmt")}
                >
                  Calculate Interest Amount{" "}
                  {renderSortArrow("strCalculateInterestAmt")}
                </th>
                <th
                  scope="col"
                  className="py-2.5 px-7 whitespace-nowrap"
                ...
                <th
                  scope="col"
                  className="py-2.5 px-7 whitespace-nowrap"
                  onClick={() => handleSort("billedFlag")}
                >
                  Billed Flag
                  {renderSortArrow("billedFlag")}
                </th>
              </thead>
                    ...
                    {sortedData
                        ...
                        return (
                          ...
                          (data.strAccountType &&
                            data.strAccountType
                              .toLowerCase()
                              .includes(searchQueryLower)) ||
                          ((typeof data.strTxnAmount === "string" ||
                            typeof data.strTxnAmount === "number") &&
                            data.strTxnAmount
                              .toString()
                              .toLowerCase()
                              .includes(searchQueryLower)) ||
                      ...
                      .map((data) => (
                        ...
                        >
                          ...
                          <td className="px-7 py-2.5 whitespace-nowrap">
                            {data.strAccountType || "-"}
                          </td>
                          <td className="whitespace-nowrap px-7 py-2.5">
                            {data.strAccountNumber || "-"}
                          </td>

                          <td className="px-7 py-2.5 whitespace-nowrap text-end">
                            {data.strTxnAmount || "-"}
                          </td>

                          <td className="px-7 py-1 whitespace-nowrap text-right">
                            {data.strCalculateInterestAmt || "-"}
                          </td>
                          ...
                          <td className="px-7 py-1 whitespace-nowrap ">
                            {data.billedFlag || "-"}
                          </td>
                        </tr>
                      ))}
