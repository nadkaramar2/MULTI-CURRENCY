...
const AccountSummery = () => {
  ...
  const responseCode = async () => {
    try {
      const response = await amsApi
        .get
        // `ResponseCodeMaster/getResponseCode`
        ();
      if (response.data.code === "S0000") {
        ...
        <div className="w-full shadow-md mt-2">
          <div className="px-9 sm:px-9 bg-blue-200">
            <div className=" flex  items-center justify-between">
              <p className="flex justify-start font-sans sm:text-lg text-black text-sm leading-normal">
                Account Type Master
              </p>
                ...
                <div className="grid gap-4  md:grid-cols-4  px-9">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Spcific"> Specific </option>
                  ...
                  <div>
                    ...
                    >
                      Account Number<span className="text-red-600 px-2">*</span>
                    </label>
                    <input
                      type="text"
                      id="accountMaster"
                          ...
                          >
                            <td className="whitespace-nowrap px-9 py-1">
                              <button
                                ...
                                onClick={() => searchTransaction(cust_id)}
                              >
                                {cust_id || "-"}
