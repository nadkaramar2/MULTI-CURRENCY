...
export default function GLtoAccount() {
  ...
  const handleClick = () => {
    ...
    setTotype("");
    setFNameCust([]);
    setFNameCust([]); // Clear the "To Account Description" field
    setToNameCust([]);
    setTodata([]);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      setError(true);
    } else if (!userId || !AccountNumberfrom) {
      handleShowError("Please check your userId ");
    } else if (!AccountNumberfrom) {
      handleShowError("Please check your From GL AccountNumber ");
    } else {
      try {
              ...
              <div className=" px-4 py-1 bg-rose-300  ">
                <div className="grid gap-6  md:grid-cols-2   ">
                  ...
                  <div className=" text-start">
                    ...
                    <input
                      type="text"
                      id="GLdescriptionfrom"
                      // onClick={NameCust}
                      defaultValue={GLdescriptionfrom}
                      autoComplete="off"
                      disabled
                      placeholder="Enterfrom gl Account Desc.."
                  ...
                  <div className=" text-start">
                    ...
                    <input
                      ...
                      disabled
                      autoComplete="off"
                      placeholder="enter From GL account number"
                      className="block w-full px-3 py-1 text-sm font-normal text-gray-700 bg-gray-100 bg-clip-padding border border-solid border-gray-500 rounded transition ease-in-out m-0"
                    />
                  </div>
                  <div className="  text-start">
                ...
                <div className="grid gap-6  md:grid-cols-2  ">
                  ...
                  <div className=" text-start ">
                    ...
                    <div>
                      <input
                        ...
                        disabled
                        autoComplete="off"
                        placeholder="Enter To Account Desc.."
                        className="block w-full px-3 py-1 text-sm font-normal text-gray-700 bg-gray-100 bg-clip-padding border border-solid border-gray-500 rounded transition ease-in-out m-0"
                      />
                    </div>
                  </div>
                  ...
                  <div className="  text-start">
                    ...
                    <input
                      ...
                      autoComplete="off"
                      disabled
                      placeholder="Enter To Account holder name"
                      className="block w-full px-3 py-1 text-sm font-normal text-gray-700 bg-gray-100 bg-clip-padding border border-solid border-gray-500 rounded transition ease-in-out m-0"
                    />
                  </div>
