...
export default function NetworkTypeMaster() {
  ...
  // save form
  const networkSubmit = async (event) => {
    ...
    if (
      ...
      try {
        const response = await amsApi.post(`networktype/addnetworktype`, {
  ...
  const ViewNetwork = async () => {
    try {
      ...
      if (response.data.code === "S0000") {
        setResData(response.data.networkTypeData);
      } else {
    ...
    <AppLayout>
      <div className="max-w-7xl mx-auto h-full">
        ...
        <div className=" bg-white sm:rounded-md">
          <form className="" onSubmit={networkSubmit}>
              ...
              <div className="px-4 py-2 sm:p-2 bg-white">
                <div className="grid gap-2  lg:grid-cols-1 md:grid-cols-1 px-8">
                  <div className="flex">
                    ...
                    >
                      Network Type<span className="text-red-600 px-2">*</span>
                    </label>
                    <input
                      type="text"
                      id="networkType"
                    ...
                    />
                    {error && networkType.length <= 0 ? (
                      <p className="text-red-500   text-xs font-medium">
                        Please Enter Network Type
                      </p>
                    ) : (
                      ""
                    )}
                  ...
                  <div className="flex">
                    ...
                    <input
                      ...
                      autoComplete="off"
                    />
                    {error && networkDescription.length <= 0 ? (
                      <p className="text-red-500   text-xs font-medium">
                  ...
                  <div className="flex">
                    <label
                      htmlFor="text"
                      className="block w-auto px-3 py-1 mr-8 text-base font-normal text-gray-700 bg-white  "
                    >
                      GL Account Link{""}
