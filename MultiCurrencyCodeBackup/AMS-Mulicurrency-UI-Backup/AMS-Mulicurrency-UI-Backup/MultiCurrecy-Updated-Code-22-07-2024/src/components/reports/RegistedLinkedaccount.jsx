...
export default function RegistedLinkedaccount() {
    ...
    if (
      ...
      try {
        const response = await amsApi.post(
          `preSubAccountMaster/getPendngRegCustWithLinkAccount/pagination/${itemPage}/${tcount}`,
          {
            fromDate: startdate,
            strTxnTypeKeyWord: status,
            toDate: enddate,
          },
          {
            headers: {
        ...
        if (response.data.code === "S0000") {
          setalldata(response.data.preSubAccountMaster);
     ...
     const Search = async () => {
       try {
         const response = await amsApi.post(
           `preSubAccountMaster/getPendngRegCustWithLinkAccount/pagination/20/1 `,
           {
             keyword: searchQuery,
           }
         );
          ...
          <div className="px-4 sm:px-10  bg-blue-800 ">
            <div className=" flex  items-center justify-between">
              <p className="flex justify-start  text-white text-md  font-semibold leading-normal">
                Register Customer Linked Account Report
              </p>
              <div>
                <button className="inline-flex sm:ml-3 mt-4 sm:mt-0 items-start justify-start px-6 focus:outline-none rounded textxs font-medium">
                  <Switch
                    checked={checked}
                ...
                <div className=" px-4 sm:p-2 bg-white  ">
                  <div className="grid gap-6 md:grid-cols-5 px-8 ">
                    <div>
                      ...
                      >
                        Satus <span className="text-red-600 px-2">*</span>
                      </label>
                      <select
                        id="status"
                        name="status"
            ...
            <div className="table-wrp block max-h-[27rem] ">
              <table className="w-full text-xs  text-left text-black dark:text-blue-100">
                <thead className="w-full text-white border-b sticky top-0 bg-blue-500 ">
                  ...
                  >
                    Registration Date {renderSortArrow("strDateOfRegistration")}
                  </th>
                  <th
                    scope="col"
                    className="py-1 px-6 whitespace-nowrap"
                  ...
                  >
                    Account Type Description {renderSortArrow("strDescription")}
                  </th>
                  <th
                    scope="col"
                    className="py-1 px-6 whitespace-nowrap"
                    onClick={() => handleSort("ageing")}
                  >
                    Ageing {renderSortArrow("ageing")}
                  </th>
                </thead>
                <tbody>
                  {sortedData.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan="10" className="px-6 py-1 text-center">
