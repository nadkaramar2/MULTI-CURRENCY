...
export default function ViewUnbilledTxn() {
    ...
    if (duration === "" || accountno === "") {
      ...
      try {
        const response = await amsApi.post(
          `revolvingCreditCardTxn/getUnbilledData/pagination/${itemPage}/${tcount}`,
          {
            fromDate: startdate,
            toDate: enddate,
          ...
          <div className="px-4 sm:px-10 bg-blue-200 ">
            <div className=" flex  items-center justify-between">
              ...
              <div className="flex justify-end rounded-md border border-transparent px-1  text-sm font-medium text-white ">
                ...
                <button className="inline-flex sm:ml-3 mt-1 sm:mt-0 items-start justify-start px-2 focus:outline-none rounded text-xs font-medium">
                  <Switch
                    checked={checked}
          ...
          <div className="table-wrap block max-h-[27rem] max-w-5xl  ">
            <table className="w-full text-xs text-left text-black dark:text-blue-100">
              <thead className="text-xs border-b sticky top-0 text-gray-400 uppercase bg-gray-100 dark:text-white">
                ...
                >
                  payment DueDate{renderSortArrow("paymentDueDate")}
                </th>
                <th
                  scope="col"
                  className="py-2.5 px-2 whitespace-nowrap"
