...
export default function CashDeposite() {
    ...
    if (
      ...
      try {
        const response = await amsApi.post(
          `denomination_master/getTxnDenominationDetail`,
          {
        ...
        <div className="w-full shadow-md mt-2 ">
          <div className="px-4 sm:px-10 bg-blue-200 ">
            <div className=" flex  items-center justify-between">
              ...
              <div>
                <button className="inline-flex sm:ml-3 sm:mt-0 items-start justify-start px-4 focus:outline-none rounded text-xs font-medium">
                  <Switch
                    checked={checked}
            ...
            <form className="">
              <div className="overflow-hidden shadow ">
                <div className=" px-4 sm:p-2 bg-white  ">
                  <div className="grid gap-4  md:grid-cols-5 px-8">
                    <div>
                      <label
                        htmlFor="text"
                      ...
                      <input
                        ...
                        className="block w-full px-4 py-1 text-sm font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-500 rounded transition ease-in-out m-0 "
            ...
            <div className="table-wrp block max-h-[27rem] max-w-[27rem]">
              <table className="w-full text-xs text-left text-black dark:text-blue-100">
                <thead className="text-xm border-b sticky top-0 text-gray-400 uppercase bg-gray-100 dark:text-white">
                  ...
                  >
                    Agent account number {renderSortArrow("toAccount")}
                  </th>
                  <th
                    scope="col"
                    className="py-2.5 px-4 whitespace-nowrap"
                  ...
                  >
                    customer account number {renderSortArrow("fromAccount")}
                  </th>
                  <th
                    scope="col"
                    className="py-2.5 px-4 whitespace-nowrap"
                ...
                <tbody>
                  {sortedData.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan="16" className="px-4 py-1 text-center">
