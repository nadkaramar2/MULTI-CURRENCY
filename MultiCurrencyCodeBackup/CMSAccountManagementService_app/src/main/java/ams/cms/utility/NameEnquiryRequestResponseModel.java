...
public class NameEnquiryRequestResponseModel implements Serializable
{
	...
	public String toString() {
		return "NameEnquiryRequestResponseModel [code=" + code + ", data=" + data + ", message=" + message
				+ ", success=" + success + ", appId=" + appId + ", auditId=" + auditId + ", participantId="
				+ participantId + ", recipientAccountNumber=" + recipientAccountNumber + ", senderAccountNumber="
				+ senderAccountNumber + ", recipientInstitutionCode=" + recipientInstitutionCode
				+ ", recipientBankCode=" + recipientBankCode + ", accountNumber=" + accountNumber + ", accountName="
				+ accountName + ", bankVerificationNumber=" + bankVerificationNumber + ", kycLevel=" + kycLevel
				+ ", currencyCode=" + currencyCode + ", customerNo=" + customerNo + ", sessionID=" + sessionID
				+ ", channelCode=" + channelCode + ", destinationInstitutionCode=" + destinationInstitutionCode
				+ ", responseCode=" + responseCode + ", responseDescr=" + responseDescr + "]";
	}	
}
